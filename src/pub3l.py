...
class Pub():
    def __init__(self):
        ...
        self.sp_publisher0 = rospy.Publisher('/brazo/joint0_position_controller/command', Float64, queue_size=1)
        self.sp_publisher1 = rospy.Publisher('/brazo/joint1_position_controller/command', Float64, queue_size=1)
        self.sp_publisher2 = rospy.Publisher('/brazo/joint2_position_controller/command', Float64, queue_size=1)
    ...
    def move_robot(self):
        while not self.ctrl_c: 
            ...
            self.command1 = self.command1*180/math.pi
            self.sp_publisher1.publish(self.command1)
            self.command2 = self.command2*180/math.pi
